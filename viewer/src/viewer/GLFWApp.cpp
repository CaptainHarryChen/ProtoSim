...
#include <viewer/GUI/ImGuiSystem.h>

// Use high performance GPU on hybrid graphics systems
#ifdef _WIN32
#ifdef __cplusplus
extern "C" {
#endif  // __cplusplus
...
{
    std::call_once(g_main_class_flag, [&] { g_main_class_ptr = std::shared_ptr<GLFWApp>(new GLFWApp(name, init_width, init_height)); });
    return g_main_class_ptr;
}
