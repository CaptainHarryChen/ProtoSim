...
Sphere::Sphere(std::vector<Point> vertices, glm::vec2 material)
{
...
void Sphere::Draw() // outer call for shadow-mapping
{
...
void Sphere::UpdateVertices(std::vector<Point> data)
{
    glBindVertexArray(VAO);
    vertices = data;
