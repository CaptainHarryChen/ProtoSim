...
int main()
{
    ...
    // scene->AddMPMCubeParticleBatch(glm::vec3(-0.5f, 4.0f, -0.5f), glm::vec3(0.5f, 5.0f, 0.5f), 0.08f,
    //                                MPM_ELASTIC, 1000.0f,
    //                                0.03f, glm::vec3(0.2f, 0.2f, 1.0f), glm::vec2(0.8f, 0.8f));
    ...
    scene->AddMPMCubeParticleBatch(glm::vec3(-1.0f, 2.0f, -1.0f), glm::vec3(1.0f, 3.0f, 1.0f), 0.08f,
                                   MPM_ELASTIC, 3000.0f,
